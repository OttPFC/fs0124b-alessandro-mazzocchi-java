package com.esercizio.Esercizio;

import com.esercizio.Esercizio.entities.*;
...
public class OrdersRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(EsercizioApplication.class);
		try {
